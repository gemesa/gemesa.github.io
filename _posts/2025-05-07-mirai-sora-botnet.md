...
```
{% include_file external/threat-detection-rules/mirai-sora-arm/mirai-packed.yar %}
```

##### Unpacked binary

```
{% include_file external/threat-detection-rules/mirai-sora-arm/mirai-unpacked.yar %}
```
...
```
$ cat mirai.rules
{% include_file external/threat-detection-rules/mirai-sora-arm/mirai.rules %}
...
```yml
{% include_file external/threat-detection-rules/mirai-sora-arm/mirai-sora-botnet.yml %}
```
