...
```java
{% include_file external/reversing-scripts/ChromeUpdaterCrypt.java %}
```
...
```
{% include_file external/threat-detection-rules/fake-chrome-updater/fake_chrome_updater_xml_android.yar %}
```

```
{% include_file external/threat-detection-rules/fake-chrome-updater/fake_chrome_updater_dex_android.yar %}
```
