...
![app icon]({{site.baseurl}}/assets/xloader/ic_launcher.png)
...
> Note: The short summary of the native (`ni.*`) functions have been added manually for better understanding.
