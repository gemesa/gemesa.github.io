...
```
{% include_file external/threat-detection-rules/hancitor/hancitor-packed.yar %}
```
...
```
{% include_file external/threat-detection-rules/hancitor/hancitor-unpacked.yar %}
```
### Suricata
...
```
$ cat hancitor.rules
{% include_file external/threat-detection-rules/hancitor/hancitor.rules %}
...
```yml
{% include_file external/threat-detection-rules/hancitor/hancitor-loader.yml %}
```
